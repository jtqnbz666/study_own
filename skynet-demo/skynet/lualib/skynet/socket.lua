...
-- SKYNET_SOCKET_TYPE_CONNECT = 2			SOCKET_OPEN
socket_message[2] = function(id, _ , addr)		
	local s = socket_pool[id]		-- 和225对应  超级重点
	if s == nil then
		return
	end
	-- log remote addr
...
local function connect(id, func)
	...
	socket_pool[id] = s				-- 记住这一行 107对应  超级重点
	suspend(s)						-- 挂起协程
